...
@WebServlet("/selectUpdateAdminServlet")
public class selectUpdateAdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("web/admin/role_manager/update/adminUpdate.jsp").forward(request, response);
