	...
	<div class="content">
		...
		<div class="contentext">
			...
			<div class="user" align="center">
				 <form action="" method="post" > 
				  <div class="register"> 
					 ...
					 %>					
					 <label>密码：</label><input type="text" name="cus_password" value="<%=customer.getCus_password()%>"/><br/><br/>			 		
            ...
            %> 
				...
				<form action="/jiudianxitong/updatePasswordServlet" method="post" >
				  <!-- <div class="register">  -->
                     <h2>新密码</h2><br/>
                      <label>密码：</label><input type="text" name="cus_password" "/><br/><br/>			 		
					 <input type="submit" id="button" value="修改">&nbsp;&nbsp;
				 </div> 
			</form>
		</div>
